...
db.execute("CREATE TABLE IF NOT EXISTS ctf_problems(ctf_problem_name text PRIMARY KEY, ctf_problem_flag text, ctf_problem_type text, ctf_problem_contents text, ctf_problem_file text, ctf_problem_solved int, ctf_problem_score int, ctf_problem_visible text)")
